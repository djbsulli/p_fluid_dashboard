...
def load_data():
    ...
    player_season = pd.read_parquet(os.path.join(SCRIPT_DIR, "pf2_player_season.parquet"))
    team_match    = pd.read_parquet(os.path.join(SCRIPT_DIR, "pf2_team_match.parquet"))
    team_season   = pd.read_parquet(os.path.join(SCRIPT_DIR, "pf2_team_season.parquet"))
    player_match  = pd.read_parquet(os.path.join(SCRIPT_DIR, "pf2_player_match.parquet"))
