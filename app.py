...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab_team_season:
        ...
        all_leagues_rank = int((avg_team_fluidity['season_z'] > team_row['season_z']).sum()) + 1
        total_all = len(avg_team_fluidity)
        league_rank = int((avg_team_fluidity[avg_team_fluidity['competition'] == team_row['competition']]['season_z'] > team_row['season_z']).sum()) + 1
