...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab_season:
        ...
        st.markdown('<div class="section-header">Season Overview</div>',
                    unsafe_allow_html=True)
        ...
        with col_map:
            st.markdown('<div class="section-header">Touch Map</div>', unsafe_allow_html=True)
    ...
    with tab_match:
        ...
        st.markdown("<div style='font-size:1.1rem; font-weight:700; color:#2c3e50; margin-bottom:4px;'>Select Match</div>", unsafe_allow_html=True)
        selected_match_opt = st.selectbox("Select Match", match_options, key="player_match_select", label_visibility="collapsed")
        ...
        st.markdown(f'<div class="section-header">Touch Map ({len(match_locs)} touches)</div>', unsafe_allow_html=True)
        st.markdown("<div style='font-size:0.8rem; color:#6c757d; margin-bottom:6px;'>Attacking direction: left → right</div>", unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab_team_season:
        ...
        with col_quad:
            st.markdown('<div class="section-header">Tactical Profile</div>', unsafe_allow_html=True)
        ...
        with col_zone:
            st.markdown('<div class="section-header">Zonal Fluidity Breakdown (season averages)</div>', unsafe_allow_html=True)
        ...
        st.markdown('<div class="section-header">Matches Distribution (match-level z scores)</div>', unsafe_allow_html=True)
    ...
    with tab_team_match:
        ...
        st.markdown("<div style='font-size:1.1rem; font-weight:700; color:#2c3e50; margin-bottom:4px;'>Select Match</div>", unsafe_allow_html=True)
        selected_match_label = st.selectbox("Select Match", list(match_opts.keys()), label_visibility="collapsed")
        ...
        st.markdown('<div class="section-header">Zonal Breakdown (match-level z scores)</div>', unsafe_allow_html=True)
