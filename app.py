...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab_team_season:
        ...
        st.markdown('<div style="font-size:0.82rem;">', unsafe_allow_html=True)
    ...
    with tab_team_match:
        ...
        with col_mzone:
            ...
            m_colours = ['#2ecc71' if v > s else '#e74c3c'
                         for v, s in zip(match_values, seasonal_values)]
        ...
        with col_minfo:
            ...
            def zone_html(label, raw_val, avg_val):
                ...
                return (f"<div style='margin-bottom:10px;'>"
                        f"<span style='color:#555; font-size:0.85rem;'>{label}</span><br>"
                        f"<span style='font-weight:700; font-size:1.05rem; color:{colour_diff(diff)};'>"
                        f"{fmt_diff(diff)} vs avg</span></div>")
            ...
            st.markdown(
                ...
                f"<div style='font-weight:700; font-size:1rem; color:#2c3e50; margin-bottom:12px;'>vs {opponent_name}</div>"
