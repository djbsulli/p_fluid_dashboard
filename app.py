...
VALID_TOUCHES_GDRIVE_ID = "1MiX3alHkzZ5yZqBrygVE3R9I5NQ8suu0"
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with tab_team_match:
        ...
        # Build team matches with opponent and home/away from team_match_stats
        ha_lookup = team_match_stats[['match_id', 'team', 'home_away']].drop_duplicates()
        team_matches_with_meta = team_matches.merge(ha_lookup, on=['match_id', 'team'], how='left')
