...
if page == "🏠 Home":
    ...
    with col1:
        ...
        """, unsafe_allow_html=True)
        if st.button("Go to Player Statistics →", use_container_width=True):
            st.session_state["page"] = "👤 Player Statistics"
            st.rerun()
    ...
    with col2:
        ...
        """, unsafe_allow_html=True)
        if st.button("Go to Team Statistics →", use_container_width=True):
            st.session_state["page"] = "🏟️ Team Statistics"
            st.rerun()
